...
class TypeScriptAsset extends JSAsset {
  parse(code) {
    ...
    return _asyncToGenerator(function* () {
      ...
      _this.sourceMap = transpiled.sourceMapText;

      if (_this.sourceMap) {
        _this.sourceMap = JSON.parse(_this.sourceMap);
        _this.sourceMap.sources = [_this.relativeName];
        _this.sourceMap.sourcesContent = [_this.contents];
      ...
      _this.contents = transpiled.outputText;
